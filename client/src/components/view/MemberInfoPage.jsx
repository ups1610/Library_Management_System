            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
                ...
                <div className="h-96 rounded-lg bg-white">
                    ...
                    {!membershipInfo && (
                         ...
                         <h2 className="text-left mb-4 font-semibold mt-4 px-4">Membership Information</h2>
                         <div className="flow-root">
                         <p className="text-red-600 px-4">This Member does not have an active membership.<br></br> Please take any membership plan soon.<br></br>To add membership, please click the button below.<br></br>Thank you !</p>
