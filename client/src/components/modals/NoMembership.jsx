                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-start">
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h2 className="text-lg leading-6 font-semibold text-gray-900 mb-3 text-center">Membership Details</h2>
                                <p className="text-red-600">This Member does not have an active membership. Please take any membership plan soon.</p>
